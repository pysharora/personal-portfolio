    ...
    <section className="hero" aria-labelledby="intro">
      ...
      <h1 id="intro">
        ...
        <span className="accent">
          that connects product thinking with engineering.
        </span>
      </h1>
      ...
      <div className="intro-row">
        ...
        <div className="intro-copy">
          <p>
            ...
            an MBA lens, building digital experiences that are useful, clear,
            and designed to work in the real world.
          </p>

          <p className="muted">
            My work sits at the overlap of engineering, UX, and business logic:
            shipping thoughtful interfaces, reliable systems, and tools that
            make teams move faster.
          </p>
